...
def run():
    ...
    st.write("Options for cut are: Fair, Good, Very Good, Premium, Ideal")
    cut = st.selectbox("Cut", ["Fair", "Good", "Very Good", "Premium", "Ideal"])
    st.write("Options for color are: D, E, F, G, H, I, J")
    color = st.selectbox("Color", ['D', 'E', 'F', 'G', 'H', 'I', 'J'])
    st.write("Options for clarity are: I1, SI2, SI1, VS2, VS1, VVS2, VVS1, IF")
